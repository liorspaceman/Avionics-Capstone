...
PID_clsys = pid(C_clsys_tune)
Kdt_2pole_2 = PID_clsys.kd
Kpt_2pole_2 = PID_clsys.kp
Kit_2pole_2 = PID_clsys.ki

fprintf('\nPitch2pole:')
PID_Pitch_new_2pole = pid(C_Pitch_new_2pole_2)
...
clsys = feedback(G_Pitch_new_2pole_1*C_Pitch_new_2pole_1,1); 
C_PID_travel_1 = pidtune(clsys*G_Travel_new_2pole_1,pidstd(1,1,1),0.8);
C_PID_travel=pid(C_PID_travel_1)
Kp_PID_travel=C_PID_travel.Kp;
Ki_PID_travel=C_PID_travel.Ki;
Kd_PID_travel=C_PID_travel.Kd;

clsys_2 = feedback(G_Pitch_new_2pole_1*C_Pitch_new_2pole_2,1); 
C_PID_travel_2 = pidtune(clsys_2*G_Travel_new_2pole_1,pidstd(1,1,1),2);
C_PID_travel_2=pid(C_PID_travel_2)
Kp_PID_travel_2=C_PID_travel_2.Kp;
Ki_PID_travel_2=C_PID_travel_2.Ki;
Kd_PID_travel_2=C_PID_travel_2.Kd;
%% Defining parameters
